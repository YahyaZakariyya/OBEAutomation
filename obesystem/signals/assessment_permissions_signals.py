...
def assign_permissions_for_assessment(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        assign_perm('obesystem.view_assessment', faculty_group, instance)
        assign_perm('obesystem.change_assessment', faculty_group, instance)
        assign_perm('obesystem.delete_assessment', faculty_group, instance)
        assign_perm('obesystem.can_add_question', faculty_group, instance)

        # Assign view permissions to the students group for the assessment
        assign_perm('obesystem.view_assessment', students_group, instance)
...
def remove_permissions_for_assessment(sender, instance, **kwargs):
    ...
    remove_perm('obesystem.view_assessment', faculty_group, instance)
    remove_perm('obesystem.change_assessment', faculty_group, instance)
    remove_perm('obesystem.delete_assessment', faculty_group, instance)
    remove_perm('obesystem.can_add_question', faculty_group, instance)

    # Remove view permissions for the students group
    remove_perm('obesystem.view_assessment', students_group, instance)